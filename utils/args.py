...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--max_seq_len', type=int, default=128, help='Maximum sequence length for BERT input')
    ...
    arg_parser.add_argument('--eztrain', default=True, type=bool, help='Whether only train a single net')
    return arg_parser